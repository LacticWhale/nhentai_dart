...
class BookTitleMapper extends ClassMapperBase<BookTitle> {
  ...
  static const Field<BookTitle, String> _f$english = Field(
    'english',
    _$english,
    opt: true,
  );
  static String? _$japanese(BookTitle v) => v.japanese;
  static const Field<BookTitle, String> _f$japanese = Field(
    'japanese',
    _$japanese,
    opt: true,
  );
...
mixin BookTitleMappable {
  String toJson() {
    return BookTitleMapper.ensureInitialized().encodeJson<BookTitle>(
      this as BookTitle,
    );
  }

  Map<String, dynamic> toMap() {
    return BookTitleMapper.ensureInitialized().encodeMap<BookTitle>(
      this as BookTitle,
    );
  }
  ...
  @override
  String toString() {
    return BookTitleMapper.ensureInitialized().stringifyValue(
      this as BookTitle,
    );
  }
}
...
abstract class BookTitleCopyWith<$R, $In extends BookTitle, $Out>
  ...
  $R call({String? pretty, String? english, String? japanese});
