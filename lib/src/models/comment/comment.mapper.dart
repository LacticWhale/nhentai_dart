...
class CommentMapper extends ClassMapperBase<Comment> {
  ...
  static const Field<Comment, int> _f$bookId = Field(
    'bookId',
    _$bookId,
    key: r'gallery_id',
  );
  static User _$poster(Comment v) => v.poster;
  static const Field<Comment, User> _f$poster = Field('poster', _$poster);
  static DateTime _$posted(Comment v) => v.posted;
  static const Field<Comment, DateTime> _f$posted = Field(
    'posted',
    _$posted,
    key: r'post_date',
    hook: DateHook(),
...
abstract class CommentCopyWith<$R, $In extends Comment, $Out>
  ...
  UserCopyWith<$R, User, User> get poster;
  $R call({int? id, int? bookId, User? poster, DateTime? posted, String? body});
...
class _CommentCopyWithImpl<$R, $Out>
  ...
  Comment $make(CopyWithData data) => Comment(
    ...
    posted: data.get(#posted, or: $value.posted),
